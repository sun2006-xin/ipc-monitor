...
class VideoWidget(QWidget):
    ...
    # ------------------------------------------------------------
    # C2 聚集阈值 setter（默认 5 人；答辩现场可以 setter 改成 3 人演示更明显）
    # ------------------------------------------------------------
    ...
    def update_frame(self):
        ...
        try:
            ...
            #   目的：夜间红外/暗光画面 YOLO 检测率从 30% 提升到 80% 以上（答辩现场关窗帘直接演示差异）
            ...
            try:
                ...
                # ================================================================
                # B2/C2/C3/C4 画面水印叠加（答辩演示一眼能看到功能在跑，老师不用翻代码）
                #   - C4 🌙 夜间增强（右上角小图标）
                #   - C2 ⚠ 聚集 N 人（顶部居中大红字）
